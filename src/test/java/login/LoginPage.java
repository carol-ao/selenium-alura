...
// Classe criada para seguir o padrão Page Object, em que os métodos do Selenium(ferramenta usada
// para automação) ficam separados
...
public class LoginPage extends PageObject {
  ...
  public boolean isPaginaErroDeLogin() {
    return browser.getCurrentUrl() != null
        && browser.getCurrentUrl().equals(URL_LOGIN_ERROR)
